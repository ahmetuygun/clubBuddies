...
@RestController
@RequestMapping("/api/club-buddies-kafka")
public class ClubBuddiesKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ClubBuddiesKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ClubBuddiesKafkaResource(KafkaProperties kafkaProperties) {
